...
Simple Ticket Management CRUD API – NestJS + TypeORM + MySQL.
...
- `POST /ticket-comments`, `GET /ticket-comments`, `GET /ticket-comments/:id`, `PATCH /ticket-comments/:id`, `DELETE /ticket-comments/:id`
